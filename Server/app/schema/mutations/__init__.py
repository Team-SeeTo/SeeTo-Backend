...
from app.schema.mutations.todo import NewToDoMutation, UpdateToDoMutation, DeleteToDoMutation, CompleteToDoMutation,\
...
class Mutation(graphene.ObjectType):
    ...
    complete_todo = CompleteToDoMutation.Field()
